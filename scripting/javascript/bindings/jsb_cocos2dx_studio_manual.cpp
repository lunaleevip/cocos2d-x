...
void register_all_cocos2dx_studio_manual(JSContext* cx, JSObject* global)
{
    ...
    if (jsb_LayoutParameter_prototype) {
    ...
    if (jsb_CCArmatureAnimation_prototype) {
    ...
    if (jsb_CCArmatureDataManager_prototype)
