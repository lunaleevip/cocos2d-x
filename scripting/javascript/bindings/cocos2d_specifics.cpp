...
void register_cocos2dx_js_extensions(JSContext* cx, JSObject* global)
{
    ...
    if (jsb_CCSpriteBatchNode_prototype)
    ...
    if (jsb_CCParticleBatchNode_prototype)
    ...
    if (jsb_CCParticleSystem_prototype)
    ...
    if (jsb_CCSpriteFrame_prototype) {
