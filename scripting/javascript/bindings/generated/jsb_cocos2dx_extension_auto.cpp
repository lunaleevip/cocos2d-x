...
void js_register_cocos2dx_extension_CCScrollView(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("initWithViewSize", js_cocos2dx_extension_CCScrollView_initWithViewSize, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
void js_register_cocos2dx_extension_CCTableView(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("initWithViewSize", js_cocos2dx_extension_CCTableView_initWithViewSize, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
void js_register_cocos2dx_extension_CCEditBox(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec st_funcs[] = {
		JS_FN("create", js_cocos2dx_extension_CCEditBox_create, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
