...
JSBool js_cocos2dx_CCApplication_getResourceRootPath(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCEGLView_setFrameSize(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCEGLView_setViewPortInPoints(JSContext *cx, uint32_t argc, jsval *vp);
